...
object UserInfo {
    ...
    fun save(context: Context, variables: Variables) {
        ...
        if(loginMode== LoginMode.TEL)
            saveUserData(variables)

        putToPref(context)
    }

    private fun saveUserData(variables: Variables) {
        UserInfo.fName = variables.getString("")
        UserInfo.sName = variables.getString("")
        UserInfo.mName = variables.getString("")
        UserInfo.email = variables.getString("")
        UserInfo.tel = variables.getString("")
    }
